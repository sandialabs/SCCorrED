classdef (Abstract) PatternProvider
    ...
    methods
        ...
        function pattern = getPattern(obj, imagefile, ind1, ind2)
    ...
    methods (Static, Access = protected)
        function im = cropIm(im)
            ...
            % Modified crop, TJB 2024-11-15
            % round() always rounds 0.5 up, which is not desirable
            startCol = floor((imSize(2) - imSize(1)) / 2) + 1;
